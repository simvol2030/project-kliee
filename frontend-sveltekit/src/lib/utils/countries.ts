/**
 * Countries list for checkout form
 * Sorted by most common destinations first, then alphabetically
 */
...
const otherCountries: Country[] = [
	...
	{ code: 'RO', name_en: 'Romania', name_ru: 'Румыния', name_es: 'Rumanía', name_zh: '罗马尼亚' },
	...
	{ code: 'TH', name_en: 'Thailand', name_ru: 'Таиланд', name_es: 'Tailandia', name_zh: '泰国' },
	{ code: 'TR', name_en: 'Turkey', name_ru: 'Турция', name_es: 'Turquía', name_zh: '土耳其' },
	...
	{ code: 'ZA', name_en: 'South Africa', name_ru: 'ЮАР', name_es: 'Sudáfrica', name_zh: '南非' }
];

export const countries: Country[] = [...topCountries, ...otherCountries];

/**
 * Get country name by language
 */
export function getCountryName(country: Country, lang: 'en' | 'ru' | 'es' | 'zh'): string {
	switch (lang) {
		case 'ru':
