...
export const actions: Actions = {
	default: async (event) => {
		...
		// Basic password validation (presence only, not strength)
		// Password strength validation should only apply during registration/password change
		// For login, we just check credentials - don't reveal password requirements
