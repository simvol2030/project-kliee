# K-LIEE — Codebase Context

**URL:** https://k-liee.com
**Тип:** Миграция статического сайта-портфолио художника на full-stack SvelteKit с админкой
...
├── CLAUDE.md                    # Codebase Context (этот файл)
...
*Этот файл попадает в git → GitHub → сервер*

*Изменения v4.3: обновлён заголовок и ссылки по CLAUDE.template.md Шаблон 2, workflow ссылки на ../CLAUDE.local.md*
